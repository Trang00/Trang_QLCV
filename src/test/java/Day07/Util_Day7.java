...
public class Util_Day7 {
	...
	public static String[][] getDataFromExcel(String xlFilePath, String sheetName, String tableName) throws Exception {
		...
		// FindCell sử dụng thư viện jxl 2.6 lỗi
